...
set CLASSPATH=%APP_HOME%\lib\CMU-Hero-Journey-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" oop.game.CHJ.lwjgl3.Lwjgl3Launcher %*
