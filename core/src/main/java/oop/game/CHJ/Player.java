...
public class Player {
    ...
    public Player(float startX, float startY) {
        playerTexture = new Texture(Gdx.files.internal("ShootAsset/player.PNG"));
        bookTexture = new Texture(Gdx.files.internal("ShootAsset/book.PNG"));
        try {
            gearTexture = new Texture(Gdx.files.internal("ShootAsset/gear.PNG"));
