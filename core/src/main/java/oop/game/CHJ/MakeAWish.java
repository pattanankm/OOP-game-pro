...
public class MakeAWish implements Screen {
    ...
    public void show() {
        ...
        bg = new Texture("BG/samchang.png");             // ตรวจว่าอยู่ในโฟลเดอร์ BG
        wishShrine = new Texture("NPC/elephant_Stand.PNG");  // ใช้ไฟล์ที่มีอยู่จริง
        chatBox = new Texture("BG/Chat_BB.png");          // กล่องข้อความ
    ...
    public void render(float delta) {
        ...
        if (!wishSelected) {
            ...
            font.draw(batch, "Wish selected: " + wishes[selectedWish], 450, 250);
            font.draw(batch, "Press ENTER to continue or E to exit", 450, 200);
        }
